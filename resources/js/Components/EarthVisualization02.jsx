...
const EarthVisualization02 = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full h-screen">
            ...
            <div className="mt-4 text-center text-gray-200 bg-gray-800 p-4 rounded-lg shadow-md">
                <h3 className="font-bold mb-2">Earth Controls:</h3>
                <ul className="text-sm">
                    <li>
                        <strong>Click and drag</strong>: Click and hold, then
                        move your mouse to rotate the Earth
                    </li>
                    <li>
                        <strong>Mouse wheel</strong>: Scroll up/down to zoom
                        in/out
                    </li>
                </ul>
            </div>
...
// Separate Logo component with 3D effect
const LogoImage = () => {
    ...
    useEffect(() => {
        ...
        const handleMouseMove = (e) => {
            ...
            // GSAP-like animation without GSAP dependency
...
export default EarthVisualization02;
