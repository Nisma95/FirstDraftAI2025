...
const ImgHero = () => {
  ...
  useEffect(() => {
    ...
    if (sectionRef.current && textRef.current) {
      ...
      timelineRef.current
        ...
        .fromTo(textRef.current.querySelector("h1"), { y: 0 }, { y: -50 }, 0)
        .fromTo(textRef.current.querySelector("p"), { y: 0 }, { y: -30 }, 0);
    }
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="fdHighLighTXT text-4xl md:text-9xl mb-4" dir="auto">
          {t("hero_title")}
        </h1>
        <p
          className="text-4xl md:text-5xl mb-8 text-shadow-lg text-white "
          dir="auto"
        >
          {t("hero_subtitle")}
        </p>
        ...
        <div className="mt-10 cursor-pointer scroll-arrow">
          ...
          >
            <ChevronDown size={36} color="#5a56e9" strokeWidth={2} />
          </div>
        </div>
      </div>
    </section>
